...
local raycast = PRCore.load("@pr_bridge/bridge/fivem/raycast/client", _ENV) or {}
local ui = PRCore.load("@pr_bridge/bridge/fivem/ui/client", _ENV) or {}
