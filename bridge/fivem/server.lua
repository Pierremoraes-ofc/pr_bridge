...
local identifiers = PRCore.load("@pr_bridge/bridge/fivem/identifiers/server", _ENV) or {}
...
local dui = PRCore.load("@pr_bridge/bridge/fivem/dui/server", _ENV) or {}
...
fivem.identifiers = identifiers
fivem.identifier = identifiers
